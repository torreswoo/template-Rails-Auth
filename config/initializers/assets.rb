...
Rails.application.config.assets.precompile += %w( lib/mustache.js lib/select2.js lib/select2.css lib/pagination.css)
Rails.application.config.assets.precompile += %w( lib/noty.js lib/noty.css)
